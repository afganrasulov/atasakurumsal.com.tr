...
export const metadata: Metadata = {
    title: "Turkuaz Kart",
    description:
        "Nitelikli yabancılar için Türkiye'de süresiz çalışma ve ikamet hakkı sağlayan Turkuaz Kart başvurularında VIP hukuki danışmanlık.",
            ...
            <section className="py-20 bg-gradient-to-br from-cyan-600 to-cyan-800 text-white">
                <div className="container mx-auto px-4">
                    <div className="max-w-4xl">
                        <Breadcrumb items={[{ label: "Hizmetlerimiz", href: "/hizmetlerimiz" }, { label: "Turkuaz Kart" }]} />
